...
The following example demonstrates how to use a *FuncKeyPressed* callback to
initiate the barcode scanner dialog *scannerDlg* and use the returned values to
set the line name and effectors. 

Note, the .m and .fig files (scannerExample.m and scannerExample.fig) for this
